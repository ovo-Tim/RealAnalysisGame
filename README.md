...
docker run -it --rm -p 3000:3000 ovotim/real-analysis-game:latest
```
...
# Run the container
docker run -it --rm -p 3000:3000 real-analysis-game
```

The game will be accessible at `http://localhost:3000` once the container is running.
